...
def analyze_ai(text):
    ...
    Fields: project_name, location, lat, lon, power_capacity_mw, energy_tech, pue_target, companies.
    If location is not a clear geographic place, set lat/lon to null.
